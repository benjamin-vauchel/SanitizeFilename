 ...
 */
/**
 * Build SanitizeFilename Package
 *
 * Description: Build script for SanitizeFilename package
 * @package sanitizefilename
 * @subpackage build
 */

/* Set package info be sure to set all of these */
define('PKG_NAME','SanitizeFilename');
define('PKG_NAME_LOWER','sanitizefilename');
define('PKG_VERSION','1.0.0');
define('PKG_RELEASE','beta1');
define('PKG_CATEGORY','SanitizeFilename');
...
$sources= array (
    ...
    'docs' => $root . 'core/components/sanitizefilename/docs/',
);
unset($root);
...
/* This section transfers every file in the local
 sanitizefilenames/sanitizefilename/core directory to the
 target site's core/sanitizefilename directory on install.
